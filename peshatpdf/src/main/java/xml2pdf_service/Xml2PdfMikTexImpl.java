...
public class Xml2PdfMikTexImpl implements Xml2Pdf {
    ...
    private final String xsl_standard = "xml2tex_bib_miktexbabel.xsl";



    public Xml2PdfMikTexImpl(RequestData requestData){
    ...
    public void transformXml2Tex(String xml2TexResource)  {
        ...
        InputStream stylesheet = Xml2PdfMikTexImpl.class.getResourceAsStream(xml2TexResource);
