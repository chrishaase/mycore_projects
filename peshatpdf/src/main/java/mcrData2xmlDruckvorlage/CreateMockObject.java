...
public class CreateMockObject {
    ...
    public static Lemma createMockLemma(){
        ...
        quotation0028.setBibliographicalSources(new HashSet<BibliographicalSource>());
        ...
        quotation5734.setBibliographicalSources(new HashSet<BibliographicalSource>());
        ...
        definition4668.setQuotations(new HashSet<Quotation>());
        ...
        definition4669.setQuotations(new HashSet<Quotation>());
        ...
        definition0013.setQuotations(new HashSet<Quotation>());
        ...
        lemma1.setListDefinitions(new HashSet<Definition>());
        ...
        lemma1.setListBibliographicalSources(new HashSet<BibliographicalSource>());
